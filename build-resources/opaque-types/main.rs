...
//     let path_out = out_dir.join("src/opaque_types/mod.rs");
...
//         data_out += &s;
//     }
//     let _ = std::fs::create_dir_all(path_out.parent().unwrap());
...
fn get_opaque_type_data<T>(dst_name: &str) {
    let align = std::mem::align_of::<T>();
    let size = std::mem::size_of::<T>();
    println!("type: {}, align: {}, size: {}", dst_name, align, size);
}
...
fn main() {
    ...
    get_opaque_type_data::<Option<(zenoh_ext::FetchingSubscriber<()>, &'static Session)>>("ze_owned_querying_subscriber_t");
    #[cfg(feature = "unstable")]
    /// @warning This API has been marked as unstable: it works as advertised, but it may be changed in a future release.
    /// @brief A loaned Zenoh querying subscriber.
    get_opaque_type_data::<(zenoh_ext::FetchingSubscriber<()>, &'static Session)>("ze_loaned_querying_subscriber_t");
    ...
    get_opaque_type_data::<Option<zenoh_ext::AdvancedSubscriber<()>>>("ze_owned_advanced_subscriber_t");
    #[cfg(feature = "unstable")]
    /// @warning This API has been marked as unstable: it works as advertised, but it may be changed in a future release.
    /// @brief A loaned Zenoh advanced subscriber.
    get_opaque_type_data::<zenoh_ext::AdvancedSubscriber<()>>("ze_loaned_advanced_subscriber_t");
    ...
    get_opaque_type_data::<Option<zenoh_ext::SampleMissListener<()>>>("ze_owned_sample_miss_listener_t");
    ...
    get_opaque_type_data::<Option<zenoh_ext::AdvancedPublisher<'static>>>("ze_owned_advanced_publisher_t");
    #[cfg(feature = "unstable")]
    /// @warning This API has been marked as unstable: it works as advertised, but it may be changed in a future release.
    /// @brief A loaned Zenoh advanced publisher.
    get_opaque_type_data::<zenoh_ext::AdvancedPublisher<'static>>("ze_loaned_advanced_publisher_t");
    ...
    get_opaque_type_data::<Option<NolocalJoinHandle<zenoh::Result<()>>>>("zc_owned_concurrent_close_handle_t");
    ...
    get_opaque_type_data::<Option<zenoh_ext::PublicationCache>>("ze_owned_publication_cache_t");
    #[cfg(feature = "unstable")]
    /// @warning This API has been marked as unstable: it works as advertised, but it may be changed in a future release.
    ...
    get_opaque_type_data::<Option<FifoChannelHandler<Sample>>>("z_owned_fifo_handler_sample_t");
    ...
    get_opaque_type_data::<Option<FifoChannelHandler<Query>>>("z_owned_fifo_handler_query_t");
    ...
    get_opaque_type_data::<Option<FifoChannelHandler<Reply>>>("z_owned_fifo_handler_reply_t");
